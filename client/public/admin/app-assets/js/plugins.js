...
$(function() {
   ...
   $(".collapsible").collapsible({
      ...
      onOpenStart: function() {
         // Removed open className first and add open at collapsible active
         $(".collapsible > li.open").removeclassName("open");
         setTimeout(function() {
   ...
   $(".nav-collapsible .navbar-toggler").click(function() {
      ...
      if ($(".sidenav-main").hasclassName("nav-expanded") && !$(".sidenav-main").hasclassName("nav-lock")) {
         $(".sidenav-main").toggleclassName("nav-expanded");
         $("#main").toggleclassName("main-full");
      } else {
         $("#main").toggleclassName("main-full");
      }
      ...
      if (
         ...
         $(".sidenav-main").addclassName("nav-lock");
         $(".navbar .nav-collapsible").addclassName("sideNav-lock");
      } else {
         $(this)
            .children()
            .text("radio_button_unchecked");
         $(".sidenav-main").removeclassName("nav-lock");
         $(".navbar .nav-collapsible").removeclassName("sideNav-lock");
      }
   });

   // Expand navigation on mouseenter event
   $(".sidenav-main.nav-collapsible, .navbar .brand-sidebar").mouseenter(function() {
      if (!$(".sidenav-main.nav-collapsible").hasclassName("nav-lock")) {
   ...
   $(".sidenav-main.nav-collapsible, .navbar .brand-sidebar").mouseleave(function() {
      if (!$(".sidenav-main.nav-collapsible").hasclassName("nav-lock")) {
         ...
         $(".sidenav-main.nav-collapsible, .navbar .nav-collapsible")
            .addclassName("nav-collapsed")
            .removeclassName("nav-expanded");
         $("#slide-out > li.open > a")
            .parent()
            .addclassName("close")
   ...
   // Search className for focus
   $(".header-search-input")
      .focus(function() {
         $(this)
            .parent("div")
            .addclassName("header-search-wrapper-focus");
      })
      .blur(function() {
         $(this)
            .parent("div")
            .removeclassName("header-search-wrapper-focus");
      });
   ...
   if ($("#breadcrumbs-wrapper").attr("data-image")) {
      ...
      $("#breadcrumbs-wrapper").addclassName("breadcrumbs-bg-image");
   ...
   function checkbox_check(el) {
      if (!$(el).is(":checked")) {
         $(el)
            .next()
            .css("text-decoration", "none"); // or addclassName
      } else {
         $(el)
            .next()
            .css("text-decoration", "line-through"); //or addclassName
      }
   }
   ...
   if ($("#slide-out.leftside-navigation").length > 0) {
      if (!$("#slide-out.leftside-navigation").hasclassName("native-scroll")) {
...
function slide_out_chat() {
   ...
   if (message != "") {
      var html =
         '<li className="collection-item display-flex avatar justify-content-end pl-5 pb-0" data-target="slide-out-chat"><div className="user-content speech-bubble-right">' +
