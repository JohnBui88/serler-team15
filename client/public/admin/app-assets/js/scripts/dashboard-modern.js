...
(function (window, document, $) {
    ...
    var CurrentBalanceDonutChart = new Chartist.Pie(
        ...
        },
        {
            ...
            showLabel: false,
            plugins: [
                Chartist.plugins.tooltip({ className: "current-balance-tooltip", appendToBody: true }),
                Chartist.plugins.fillDonut({
                    items: [
                        {
                            content: '<p className="small">Balance</p><h5 className="mt-0 mb-0">$ 10k</h5>'
                        }
                    ]
                })
            ]
    ...
    var TotalTransactionLine = new Chartist.Line(
        ...
        },
        {
            ...
            plugins: [Chartist.plugins.tooltip({ className: "total-transaction-tooltip", appendToBody: true })],
            fullWidth: true
        }
    );
    ...
    TotalTransactionLine.on("created", function (data) {
        ...
        if (data.type === "point") {
            var circle = new Chartist.Svg("circle", {
                ...
                "ct:value": data.y,
                r: circleRadius,
                className: data.value.y === 35 ? "ct-point ct-point-circle" : "ct-point ct-point-circle-transperent"
            });
    ...
    var UserStatisticsBarChart = new Chartist.Bar(
        ...
        },
        {
            ...
            plugins: [Chartist.plugins.tooltip({ className: "user-statistics-tooltip", appendToBody: true })]
        },
        [
