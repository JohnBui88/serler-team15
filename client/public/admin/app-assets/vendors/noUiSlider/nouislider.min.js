...
function (t) {
    ...
    function o(t, e) {
        t.classNameList ? t.classNameList.add(e) : t.className += " " + e
    }

    function s(t, e) {
        t.classNameList ? t.classNameList.remove(e) : t.className = t.className.replace(new RegExp("(^|\\b)" + e.split(" ").join("|") + "(\\b|$)", "gi"), " ")
    }
    ...
    function L(t, e) {
        if (void 0 !== e && "object" != typeof e) throw new Error("noUiSlider: 'cssclassNamees' must be an object.");
        if ("string" == typeof t.cssPrefix) {
            t.cssclassNamees = {};
            for (var n in e) e.hasOwnProperty(n) && (t.cssclassNamees[n] = t.cssPrefix + e[n])
        } else t.cssclassNamees = e
    }
    ...
    function z(e, i, l) {
        ...
        function C(e, n) {
            return !!n && t(e, i.cssclassNamees.connect)
        }

        function N(e, n) {
            return !!i.tooltips[n] && t(e.firstChild, i.cssclassNamees.tooltip)
        }

        function U(t, e, n) {
            var r = document.createElement("div"),
                s = "",
                a = [i.cssclassNamees.valueNormal, i.cssclassNamees.valueLarge, i.cssclassNamees.valueSub],
                l = [i.cssclassNamees.markerNormal, i.cssclassNamees.markerLarge, i.cssclassNamees.markerSub],
                u = [i.cssclassNamees.valueHorizontal, i.cssclassNamees.valueVertical],
                c = [i.cssclassNamees.markerHorizontal, i.cssclassNamees.markerVertical];

            function p(t, e, n) {
                return 'className="' + (r = n[1], s = (o = e) === i.cssclassNamees.value, p = s ? a : l, o + " " + (s ? u : c)[i.ort] + " " + p[r]) + '" style="' + i.style + ": " + t + '%"';
                var r, o, s, p
            }
            return o(r, i.cssclassNamees.pips), o(r, 0 === i.ort ? i.cssclassNamees.pipsHorizontal : i.cssclassNamees.pipsVertical), Object.keys(t).forEach(function (r) {
                var o, a;
                o = r, (a = t[r])[1] = a[1] && e ? e(a[0], a[1]) : a[1], s += "<div " + p(o, i.cssclassNamees.marker, a) + "></div>", a[1] && (s += "<div " + p(o, i.cssclassNamees.value, a) + ">" + n.to(a[0]) + "</div>")
            }), r.innerHTML = s, r
        }
        ...
        function k(t, e, n, r) {
            var o = function (e) {
                    return !v.hasAttribute("disabled") && (o = v, s = i.cssclassNamees.tap, (o.classNameList ? !o.classNameList.contains(s) : !new RegExp("\\b" + s + "\\b").test(o.className)) && (!!(e = function (t, e) {
                        t.preventDefault();
        ...
        function z(t, e) {
            S && (s(S, i.cssclassNamees.active), S = !1), t.cursor && (document.body.style.cursor = "", document.body.removeEventListener("selectstart", document.body.noUiListener)), document.documentElement.noUiListeners.forEach(function (t) {
                document.documentElement.removeEventListener(t[0], t[1])
            }), s(v, i.cssclassNamees.drag), B(), e.handleNumbers.forEach(function (t) {
        ...
        function H(t, e) {
            if (1 === e.handleNumbers.length) {
                ...
                o(S = n.children[0], i.cssclassNamees.active)
            }
            ...
            if (document.documentElement.noUiListeners = r.concat(s, a), t.cursor) {
                document.body.style.cursor = getComputedStyle(t.target).cursor, c.length > 1 && o(v, i.cssclassNamees.drag);
                var l = function () {
                    return !1
                };
        ...
        function D(t) {
            ...
            if (!1 === a) return !1;
            i.events.snap || n(v, i.cssclassNamees.tap, i.animationDuration), X(a, s, !0, !0), B(), A("slide", a, !0), A("set", a, !0), A("change", a, !0), A("update", a, !0), i.events.snap && H(t, {
                handleNumbers: [a]
            })
        }
        ...
        function _(t, e) {
            var o = r(t),
                s = void 0 === b[0];
            e = void 0 === e || !!e, o.forEach(I), i.animate && !s && n(v, i.cssclassNamees.tap, i.animationDuration), w.forEach(function (t) {
                X(t, b[t], !0, !1)
        ...
        return o(d = v, i.cssclassNamees.target), 0 === i.dir ? o(d, i.cssclassNamees.ltr) : o(d, i.cssclassNamees.rtl), 0 === i.ort ? o(d, i.cssclassNamees.horizontal) : o(d, i.cssclassNamees.vertical), u = t(d, i.cssclassNamees.base),
            function (e, n) {
                c = [], (p = []).push(C(n, e[0]));
                for (var r = 0; r < i.handles; r++) c.push((s = r, l = void 0, a = t(n, i.cssclassNamees.origin), t(l = t(a, i.cssclassNamees.handle), i.cssclassNamees.handleTouchArea), l.setAttribute("data-handle", s), 0 === s ? o(l, i.cssclassNamees.handleLower) : s === i.handles - 1 && o(l, i.cssclassNamees.handleUpper), a)), w[r] = r, p.push(C(n, e[r + 1]));
                var s, a, l
            }(i.connect, u), f = {
                destroy: function () {
                    for (var t in i.cssclassNamees) i.cssclassNamees.hasOwnProperty(t) && s(v, i.cssclassNamees[t]);
                ...
                if (!1 !== t && 0 !== e && e !== p.length - 1) {
                    var n = c[e - 1],
                        r = c[e],
                        s = [t];
                    o(t, i.cssclassNamees.draggable), h.fixed && (s.push(n.children[0]), s.push(r.children[0])), s.forEach(function (t) {
                        k(g.start, t, H, {
                            handles: [n, r],
                            handleNumbers: [e - 1, e]
                        })
